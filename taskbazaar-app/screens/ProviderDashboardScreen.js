...
export default function ProviderDashboardScreen() {
  ...
  useEffect(() => {
    const fetchTasks = async () => {
      ...
      const API_URL = 'http://192.168.10.9:5000/api/tasks/nearby';
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        ...
        <FlatList
          ...
          scrollEnabled={false}
          ListEmptyComponent={() => <Text style={{ textAlign: 'center' }}>No tasks found in your area. Try a different location or check back later.</Text>}
        />
      </ScrollView>
    </SafeAreaView>
  );
